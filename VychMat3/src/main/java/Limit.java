public class Limit {
    ...
    public static final double limit(IFunction function, double approach) {
    ...
    public static final double limitFromBelow(IFunction function, double approach) {
    ...
    public static final double limitFromAbove(IFunction function, double approach) {
        for (double d = approach + 10; d >= approach; d = approach
                - ((approach - d) / 10)) {
            if (function.apply(d) == Double.POSITIVE_INFINITY) {
                return Double.POSITIVE_INFINITY;
